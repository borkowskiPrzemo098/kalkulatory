  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-6 max-w-[68ch] space-y-4 text-[1.02rem] leading-relaxed text-ink-2">
        ...
        <h2 className="condensed pt-4 text-[1.3rem] font-bold text-ink">Baner zgody</h2>
        <p>
        ...
        <h2 className="condensed pt-4 text-[1.3rem] font-bold text-ink">Jakie cookies mogą się pojawić</h2>
        <p>
