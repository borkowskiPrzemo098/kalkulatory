...
export default function PolitykaCookiesPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <h1 className="display mt-5 text-[clamp(2rem,7vw,3rem)] text-ink">Polityka cookies</h1>
      <div className="mt-6 max-w-[68ch] space-y-4 text-[1.0625rem] leading-relaxed text-ink-2">
        ...
        <h2 className="pt-4 text-[1.5rem] font-extrabold tracking-[-0.02em] text-ink">Baner zgody</h2>
        <p>
        ...
        <h2 className="pt-4 text-[1.5rem] font-extrabold tracking-[-0.02em] text-ink">Jakie cookies mogą się pojawić</h2>
        <p>
