  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-6 max-w-[68ch] space-y-4 text-[1rem] leading-relaxed text-ink-2">
        <h2 className="condensed pt-4 text-[1.35rem] font-bold text-ink">1. Postanowienia ogólne</h2>
        <p>
        ...
        <h2 className="condensed pt-4 text-[1.35rem] font-bold text-ink">2. Charakter wyników</h2>
        <p>
        ...
        <h2 className="condensed pt-4 text-[1.35rem] font-bold text-ink">3. Zasady korzystania</h2>
        <p>
        ...
        <h2 className="condensed pt-4 text-[1.35rem] font-bold text-ink">4. Podmiot prowadzący serwis</h2>
        <p>
