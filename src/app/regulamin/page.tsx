...
export default function RegulaminPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <h1 className="display mt-5 text-[clamp(2rem,7vw,3rem)] text-ink">Regulamin</h1>
      <div className="mt-6 max-w-[68ch] space-y-4 text-[1.0625rem] leading-relaxed text-ink-2">
        <h2 className="pt-4 text-[1.5rem] font-extrabold tracking-[-0.02em] text-ink">1. Postanowienia ogólne</h2>
        <p>
        ...
        <h2 className="pt-4 text-[1.5rem] font-extrabold tracking-[-0.02em] text-ink">2. Charakter wyników</h2>
        <p>
        ...
        <h2 className="pt-4 text-[1.5rem] font-extrabold tracking-[-0.02em] text-ink">3. Zasady korzystania</h2>
        <p>
        ...
        <h2 className="pt-4 text-[1.5rem] font-extrabold tracking-[-0.02em] text-ink">4. Podmiot prowadzący serwis</h2>
        <p>
